...
import FinalProject.PWS.exceptions.NonexistentEntityException;
import FinalProject.PWS.exceptions.PreexistingEntityException;
...
public class PendudukJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("FinalProject_PWS_jar_0.0.1-SNAPSHOTPU");
